...
import { CELL_BUTTON_SIZES, RadioCellButton } from '@/components/cell-buttons';
...
export default {
  title: 'Buttons_Actions/RadioCell',
  component: RadioCellButton,
  argTypes: {
    title: { control: 'text' },
...
} as Meta<typeof RadioCellButton>;

const Template: StoryFn<typeof RadioCellButton> = args => <RadioCellButton {...args} />;
